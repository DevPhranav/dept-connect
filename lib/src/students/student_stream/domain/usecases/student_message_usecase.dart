...
import '../entites/studentAnnouncementMessage.dart';

class StudentMessageUseCase {
  Future<List<StudentAnnouncementMessage>> loadMessages(String? batchId) async {
    try {
      ...
      final messages = snapshot.docs.map((doc) {
        ...
        return StudentAnnouncementMessage(
          id: data['id'] ?? '',
          title: data['title'] ?? '',
  ...
  Stream<List<StudentAnnouncementMessage>> getMessageStream(String batchId) {
