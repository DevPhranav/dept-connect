...
import '../../../../students/student_stream/domain/entites/message_initial.dart';
import '../blocs/communication_announcement_details_full_screen_blocs/faculty_file_download_bloc/faculty_file_download_bloc.dart';
import '../blocs/communication_announcement_details_full_screen_blocs/faculty_file_download_bloc/faculty_file_download_event.dart';
import '../blocs/communication_announcement_details_full_screen_blocs/faculty_file_download_bloc/faculty_file_download_state.dart';
...
import '../blocs/communication_announcement_details_full_screen_blocs/faculty_message_details_page_main_bloc/faculty_message_details_state.dart';

class FacultyMessageDetailsPage extends StatelessWidget {
  final String messageID;
  const FacultyMessageDetailsPage({super.key, required this.messageID});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<FacultyMessageDetailsBloc, FacultyMessageDetailsState>(
  ...
  Widget _buildContent(BuildContext context, FacultyMessageDetailsState state) {
    if(state is FacultyMessageDetailsInitial ) {
      return Column(
      children: [
        AppBar(
          leading: IconButton(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: BlocBuilder<FacultyFileDownloadBloc, FacultyFileDownloadState>(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              BlocProvider.of<FacultyFileDownloadBloc>(
                                                  context)
                                                  .add(
  ...
  Widget _buildDownloadIcon(
      FacultyFileDownloadState states, int index,FacultyMessageDetailsInitial state, BuildContext context) {
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (fileExists) {
            ...
            return GestureDetector(
              onTap: () {
                BlocProvider.of<FacultyFileDownloadBloc>(context).add(
                  FacultyStartDownloadEvent(
                    url: downloadUrl,
                    fileName: fileName,
                    index: index,
