...
abstract class FirestoreSendDataSource {
  Future<String> sendMessageToFirebase(String announcementMessage, String titleMessage, List<Map<String, dynamic>> checkboxes, List<File> pickedFiles, DateTime editedDate, String batchId,String? sender);
