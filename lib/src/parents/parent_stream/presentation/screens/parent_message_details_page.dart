...
class ParentMessageDetailsPage extends StatelessWidget {
  final String messageID;
  const ParentMessageDetailsPage({super.key, required this.messageID});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ParentMessageDetailsBloc, ParentMessageDetailsInitial>(
  ...
  Widget _buildContent(BuildContext context, ParentMessageDetailsInitial state) {
    return Column(
      children: [
        AppBar(
          leading: IconButton(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: BlocBuilder<ParentFileDownloadBloc, ParentFileDownloadState>(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              BlocProvider.of<ParentFileDownloadBloc>(
                                                  context)
                                                  .add(
  ...
  Widget _buildDownloadIcon(
      ParentFileDownloadState states, int index, ParentMessageDetailsInitial state, BuildContext context) {
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (fileExists) {
            ...
            return GestureDetector(
              onTap: () {
                BlocProvider.of<ParentFileDownloadBloc>(context).add(
                  ParentStartDownloadEvent(
                    url: downloadUrl,
                    fileName: fileName,
                    index: index,
